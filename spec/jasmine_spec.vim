...
describe "Jasmine"
  ...
  it "runs file tests instead of nearest tests"
    ...
    Expect LastCommand() == 'jasmine-node spec/normal_spec.js'
  end
  ...
  it "runs test suites"
    ...
    Expect LastCommand() == 'jasmine-node spec/'
  end
  ...
  it "is case insensitive about the filename"
    ...
    Expect LastCommand() == 'jasmine-node spec/normalSpec.js'
  end
  ...
  it "detects CoffeeScript"
    try
      ...
      Expect LastCommand() == 'jasmine-node --coffee spec/normal_spec.coffee'

      Jasmine .

      Expect LastCommand() == 'jasmine-node --coffee .'
    finally
