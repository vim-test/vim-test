...
describe "Gradle plain"
  before
    ...
    cd spec/fixtures/gradle/java/gradle_plain_kotlin_dsl
  end
...
describe "Gradle single module"
  before
    let g:test#java#runner = 'gradletest'
    cd spec/fixtures/gradle/java/gradle_single_module_kotlin_dsl
  end
...
describe "Gradle multi module"
  before
    let g:test#java#runner = 'gradletest'
    cd spec/fixtures/gradle/java/gradle_multi_module_kotlin_dsl
  end
