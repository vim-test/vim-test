...
describe "Gradle plain module"
  before
    cd spec/fixtures/gradle/kotlin/gradle_plain_kotlin_dsl
  end
...
describe "Gradle single module"
  before
    cd spec/fixtures/gradle/kotlin/gradle_single_module_kotlin_dsl
  end
...
describe "Gradle muilti module"
  before
    cd spec/fixtures/gradle/kotlin/gradle_multi_module_kotlin_dsl
  end
